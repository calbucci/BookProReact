        ...
        let tasks = this.props.tasks.map( (task, taskIndex) => (
            <li key={task.id} className="checklist_task">
                <input type="checkbox" checked={task.done}
                    onChange={
                        this.props.tasksCallbacks.toggle.bind(null, this.props.cardId, task.id, taskIndex)
                    } 
                    />
                    {task.name}{' '}
                <a href="#" className="checklist_task-remove"
                    onClick={
                        this.props.tasksCallbacks.delete.bind(null, this.props.cardId, task.id, taskIndex)
                    } />
            </li>         
        ));      
